...
{
	public const ALMA_COMMAND_CREATE = "alma.command.create";
	public const ALMA_COMMAND_EDIT = "alma.command.edit";
	public const ALMA_COMMAND_GIVE = "alma.command.give";
	public const ALMA_COMMAND_LIST = "alma.command.list";
	public const ALMA_COMMAND_SETPAY = "alma.command.setpay";
}